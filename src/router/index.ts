...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/guest', name: 'GuestList', component: () => import('@/views/GuestList.vue') },
    { path: '/guest/:username', name: 'Guest', component: () => import('@/views/Guest.vue') },
    { path: '/guest/:username/:shareId', name: 'GuestFolder', component: () => import('@/views/Guest.vue') },
