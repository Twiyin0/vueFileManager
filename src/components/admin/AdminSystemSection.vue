...
<template>
  <section class="mt-8">
    <div class="flex items-center justify-between mb-4">
      ...
      <button class="btn-secondary text-sm flex items-center gap-1.5" @click="$emit('openUploadLimit')">
    ...
    <div class="flex items-center justify-between mb-4 mt-8">
      ...
      <div class="flex items-center gap-2">
        <button class="btn-secondary text-sm flex items-center gap-1.5" :disabled="databaseTesting" @click="$emit('testDatabase')">
          <Icon name="check" class="w-4 h-4" />
          {{ databaseTesting ? '测试中...' : '测试连接' }}
        </button>
        <button class="btn-primary text-sm flex items-center gap-1.5" :disabled="databaseSaving" @click="$emit('saveDatabase')">
